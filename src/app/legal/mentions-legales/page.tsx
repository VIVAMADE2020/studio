...
export default function MentionsLegalesPage() {
  return (
    <article>
      ...
      <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">2. Hébergement</h2>
      <p>Le site est hébergé par [Nom de l'hébergeur], dont le siège social est situé au [Adresse de l'hébergeur].</p>
      <p>Contact de l'hébergeur : [Contact hébergeur]</p>
      ...
      <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">5. Responsabilité</h2>
