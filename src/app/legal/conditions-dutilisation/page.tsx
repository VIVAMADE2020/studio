...
export default function ConditionsDUtilisationPage() {
  return (
    <article>
      ...
      <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">3. Limites</h2>
      ...
      <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">4. Modifications</h2>
      ...
      <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">5. Droit applicable</h2>
