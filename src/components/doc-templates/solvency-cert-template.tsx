    ...
    >
      ...
      <div style={styles.section}>
        ...
        <div style={{ margin: '15px 0', paddingLeft: '15px', borderLeft: '2px solid #eee' }}>
            ...
            <p><strong>Titulaire du compte VylsCapital N° :</strong> {data.accountNumber || '[Numéro de Compte]'}</p>
        </div>
      </div>
      ...
      <div style={styles.section}>
        ...
        <p>
          VylsCapital, agissant en tant qu'intermédiaire financier, certifie par la présente avoir procédé à une analyse approfondie de la situation financière du bénéficiaire susmentionné. Sur la base des documents fournis et des vérifications effectuées, le bénéficiaire est jugé éligible à un financement pour un montant maximum de :
        </p>
      ...
      <div style={styles.section}>
        ...
        <p>
          Ce certificat atteste de la pré-approbation de votre dossier de financement par VylsCapital et constitue un document essentiel dans la procédure d'octroi de votre prêt. Il témoigne du succès de l'analyse de votre solvabilité.
        </p>
        <p>
          L'étape finale pour le déblocage des fonds consistera en la signature du <strong>contrat de prêt officiel</strong>, qui formalisera l'ensemble des conditions et l'échéancier de remboursement. VylsCapital s'engage à vous accompagner dans cette dernière démarche.
        </p>
      </div>
